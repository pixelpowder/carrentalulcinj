    ...
    <section className="section" id="beaches">
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">Ulcinj sits on Montenegro's southernmost stretch of coast. Here are the four beaches our customers visit most.</p>
        </div>
        <div className="beach-grid">
          {[
            { title: 'Velika Plaza', desc: '13 km of unbroken sandy beach \u2014 the longest on the Adriatic. Shallow water, kitesurfing zones, and beach bars spread along the shore.', distance: '5 km', time: '10 min drive', image: '/img/jaz-beach.webp' },
            { title: 'Ada Bojana', desc: 'River island at the Albanian border. World-class kitesurfing, naturist beach, and rustic fish restaurants on stilts over the Bojana river.', distance: '15 km', time: '20 min', image: '/img/budva-beach.webp' },
            { title: 'Valdanos', desc: 'Secluded olive-grove bay north of town. Crystal-clear water surrounded by ancient olive trees. Quiet and uncrowded even in peak summer.', distance: '8 km', time: '15 min', image: '/img/becici-beach.webp' },
            { title: 'Mala Plaza', desc: 'The small town beach beneath the old town walls. Easy walking access from the centre. Cafes and restaurants steps away.', distance: '0.5 km', time: 'Walk', image: '/img/sveti-stefan.webp' },
          ].map((beach) => (
  ...
  useEffect(() => {
    ...
    const obs = new IntersectionObserver(([entry]) => {
      if (entry.isIntersecting) {
        const load = () => setIframeSrc('/widget.html?city_id=18&hide_search=1&v=12');
  ...
  return (
    <div className="trustpilot-banner" style={{ display: visible ? 'block' : 'none' }}>
      <div className="container">
        ...
        >
          <a href="https://www.trustpilot.com/review/carrentalulcinj.com" target="_blank" rel="noopener">Trustpilot</a>
        </div>
      </div>
    </div>
  );
      ...
      <div className="cta-banner__inner">
        <div className="reveal-up">
          ...
          <div className="cta-banner__actions">
            ...
            <a href="mailto:info@carrentalulcinj.com" className="cta-btn--outline">
              <Mail size={15} /> info@carrentalulcinj.com
            </a>
          </div>
        </div>
      </div>
