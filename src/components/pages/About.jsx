...
export default function About() {
 ...
 <p>{tf('aboutBody.p_contact_pre', 'For bookings or questions, the ')}<a href={localePath('/contact')}>{tf('aboutBody.contactPageLink', 'contact page')}</a>{tf('aboutBody.p_contact_end', ' has the form and email. We reply within two hours during business hours.')}</p>
 </ContentPage>
 );
}
