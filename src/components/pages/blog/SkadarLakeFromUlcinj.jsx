...
export default function SkadarLakeFromUlcinj() {
  ...
  return (
    ...
    >
      ...
      <p>From Ulcinj the lake is unexpectedly close. The northern edge of the lake comes within about 25 kilometres of town as the crow flies, and a drive to a useful lake-access point takes roughly 45-60 minutes depending on where you're going. It is the obvious inland counterpoint to a week on the coast.</p>

      <h2>The main access points from Ulcinj</h2>
      <p>There is no single "Lake Skadar" — you pick an entry point and work from there. The three most useful from Ulcinj are:</p>
      <ul>
        <li><strong>Virpazar.</strong> The most-visited village on the lake, a cluster of stone houses wedged between the water and the old railway line. Most lake boat trips leave from here. From Ulcinj it is about an hour via the Sozina tunnel route.</li>
        <li><strong>Murići.</strong> A small beach on the southern Montenegrin shore, reached by a winding road through villages above the lake. Closer to Ulcinj by direct road but slower because of the switchbacks. About 1 hour 15.</li>
      ...
      <h2>Boat trips from Virpazar</h2>
      <p>Virpazar has a harbour full of small tourist boats, each running broadly similar two- to four-hour cruises. The standard itinerary takes in the closer reed-beds, a couple of island monasteries (Beška, Moračnik, or Kom — depending on the operator), and a swimming stop. Prices are usually 15-25 euros per person for a group cruise, more for private charter. The village itself has several good fish restaurants and is the best on-lake lunch stop.</p>

      <h2>Žabljak Crnojevića</h2>
      <p>Not to be confused with Žabljak in the northern mountains, this Žabljak is a ruined 15th-century fortress on a rocky hill at the northern edge of the lake. It was briefly the medieval capital of Crnojević-era Zeta — essentially the proto-Montenegrin state — before being lost to the Ottomans. The walls are ruined but walkable, and the view back down over the marshland and the river bends is one of the big lake panoramas. Free entry, no ticket office, no facilities.</p>

      <h2>Rijeka Crnojevića and the viewpoint</h2>
      <p>The village of Rijeka Crnojevića sits where the Crnojević river meanders in wide loops before opening into the lake. A well-known viewpoint on the road above the village looks directly down onto the most photographed bend in Montenegro. There is a lay-by, usually room for a few cars, and no ticket.</p>
      <p>The village itself is tiny but has a couple of restaurants on the water that do lake fish — carp and eel are the local specialities. The old stone bridge (Danilov Most) is late-19th-century and still in use.</p>

      <h2>The wineries</h2>
      <p>The hills above the southern lake shore, around Crmnica, are Montenegro's main wine region. The local grape is Vranac, a deep-red variety particular to this part of the Balkans. Several family wineries near Virpazar and Limljani do tastings by appointment — phone ahead. Expect four to six wines, some local cheese and pršut (dry-cured ham), and bottle prices that are reasonable by any European standard.</p>
      ...
      <h2>When to come</h2>
      <p>Late April through June is prime — the lake is full, the water lilies are blooming in the shallow bays, and the bird life is most active. July and August can be hazy and the lake levels drop. Autumn is excellent for wine-tasting and clearer air. In winter the lake is quiet and atmospheric but many boat operators pause.</p>

      <h2>Pair with</h2>
      <p>Lake Skadar works as its own full day from Ulcinj. If you are combining, the return drive via the Sozina tunnel and the coast brings you past <a href={localePath('/blog/valdanos-olive-groves')}>Valdanos</a> for a late swim, or you can continue to <a href={localePath('/blog/shkoder-albania-day-trip')}>Shkodër</a> and return via the Albanian side of the same lake.</p>

      <div className="route-info">
        <h3>At a glance</h3>
        <div className="route-info__grid">
          <div className="route-info__item"><strong>Size</strong>Largest lake in the Balkans</div>
          <div className="route-info__item"><strong>Drive to Virpazar</strong>~1 hour via Sozina tunnel</div>
          <div className="route-info__item"><strong>Toll</strong>Sozina ~€2.50 each way</div>
          <div className="route-info__item"><strong>Boat trip</strong>~€15-25 pp from Virpazar</div>
          <div className="route-info__item"><strong>Pelican spot</strong>Pančeva Oka, with guide</div>
          <div className="route-info__item"><strong>Wine</strong>Vranac, Crmnica region</div>
        </div>
      </div>
    </ContentPage>
  );
