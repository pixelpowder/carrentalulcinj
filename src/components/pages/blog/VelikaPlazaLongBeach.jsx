...
export default function VelikaPlazaLongBeach() {
  ...
  return (
    ...
    >
      ...
      <p>If you're driving on to <a href={localePath('/blog/ada-bojana-river-island')}>Ada Bojana</a>, keep going east past Pearl Beach — the road dead-ends at the wooden bridge onto the island.</p>
      ...
      <h2>Pair with</h2>
      <p>After the beach, drive on to <a href={localePath('/blog/ada-bojana-river-island')}>Ada Bojana</a> for a fish dinner on stilts over the river, or back into town to climb <a href={localePath('/blog/ulcinj-old-town-fortress')}>Stari Grad</a> for sunset.</p>
