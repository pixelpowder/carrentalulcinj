...
export default function Terms() {
  ...
  return (
    ...
    >
      ...
      <p>Ulcinj Car Rental (carrentalulcinj.com) is an affiliate website that connects travellers with car rental services in Ulcinj, Montenegro. We are not a car rental company — we partner with LocalRent to provide real-time availability and booking services.</p>

      <h2>Booking & Rental Terms</h2>
      <p>All car rental bookings made through our website are processed and fulfilled by our partner, LocalRent. When you complete a booking, you enter into a rental agreement directly with the vehicle supplier, not with Ulcinj Car Rental.</p>
      ...
      <p>Ulcinj Car Rental acts as an intermediary and is not liable for:</p>
      <ul>
      ...
      <p>All content on this website, including text, design, and graphics, is owned by Ulcinj Car Rental unless otherwise credited. Stock photography is used under licence from Pexels.</p>

      <h2>Contact</h2>
      <p>Questions about these terms? Contact us at info@carrentalulcinj.com.</p>
    </ContentPage>
  );
}
